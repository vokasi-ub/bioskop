          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modaal-header">
                ...
                <form class="form-horizontal" action="/inputdatakategori/store" method="post">
                {{ csrf_field() }}
              <div class="box-body">
             ...
             @foreach($kategori as $k)
                 <tr>
                  ...
                  <td>{{$k->nama_kategori}}</td>
                   <td>{{$k->created_at}}</td>
                   <td>{{$k->updated_at}}</td>
                     <td>  <a href="/kategoriedit/edit/{{ $k->id_kategori }}">Edit</a> | <a href="/hapus/kategorihapus/{{ $k->id_kategori }}">Hapus</a></td>
    </tr>
  @endforeach
            </table> 
            </div>
